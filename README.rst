...
Running with Docker
-------------------
Because R is notorious for being difficult to replicate, we provide a Dockerfile
such that the exact environment used to run the analysis in the manuscript can be
reproduced. To build this environment, use:

.. code-block:: sh

   $ docker build -t ps4dr/ps4dr .
