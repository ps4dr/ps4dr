...
rm(comb1, comb2)
load(file.path(dataFolder,"drug_comb_path.drugPdisease.RData"))
...
save(drug_dis_path, drug_correlation, file = file.path(dataFolder,"drugCombination.correlationScore.drugPdisease.RData"))
