...
fine.map.pics(cluster.file = "./LocusClustering/STOPGAP_SNP_Cluster_chr", #. changed from STOPGAP_SNP_Cluster_
...
add.cluster(data.file="./GWAS_LD_var2gene/Mergedata_VEPsimplified_withGene_r2_0.7_rmMHC_genescore_cluster_generank_bestLD_chr", #. added _cluster
                        cluster.file = "./LocusClustering/STOPGAP_SNP_Cluster_chr") #. added chr

#combine stopgap.data.bestld datasets
Combine.bestld.data(data.file="./GWAS_LD_var2gene/Mergedata_VEPsimplified_withGene_r2_0.7_rmMHC_genescore_generank_bestLD_cluster_chr") #. added rm before MHC
...
mesh.gene(data.file="./GWAS_LD_var2gene/Mergedata_VEPsimplified_withGene_r2_0.7_rmMHC_genescore_generank_bestLD_cluster.RData") #. added rm before MHC
