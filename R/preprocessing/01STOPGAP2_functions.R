...
#  gwas.r2.var2gene.withGene$score3 <- cat.lookup$score[match(gwas.r2.var2gene.withGene$cat.rdb, cat.lookup$cat)]
  ...
  gwas.r2.var2gene.withGene$score8[!is.na(gwas.r2.var2gene.withGene$Single.eQTL.Tissue.p_value) & !grepl(";",gwas.r2.var2gene.withGene$Single.eQTL.Tissue.p_value) &!is.na(gwas.r2.var2gene.withGene$multi.eqtl.tissue)] <- 2
